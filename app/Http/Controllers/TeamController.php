...
{
    public function tech_web_add_adviser()
    {
        return view('admin.team.adviser',[
            'teams'=>Team::get()
        ]);

    }

    public function tech_web_store_adviser(Request $request)
    {
        Team::save_team($request);
        return back()->with('message','Team added successfully');
    }

    public function tech_web_edit_adviser($id)
    {
    ...
    public function tech_web_update_adviser(Request $request)
    {
