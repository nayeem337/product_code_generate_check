...
class WebsiteController extends Controller
{
    public function tech_web_home()
    {
        return view('frontend.home.home',[
            ...
            'blogs'=>Blog::where('status',1)->where('add_home',1)->where('publication_type',0)->get(),
...
//
    ...
    public function tech_web_about_adviser(){
          return view('frontend.about.adviser_page',[
            'banner'=>BannerAndTitle::where('page','instructor')->latest()->first(),
            'advisers'=>Team::where('status',1)->get(),
          ]);
    }
    ...
    public function tech_web_blogs_publications(){
        ...
        return view('frontend.blogs.publish_blog',[
            'banner'=>BannerAndTitle::where('page','enrollment')->latest()->first(),
            'blogs' => Blog::where('status', 1)->where('publication_type',0)->latest()->paginate(4),
            'recent_blogs' => Blog::where('status',1)->where('publication_type',0) ->latest()->take(5)->get(),
            // 'authors'=>Author::get(),
