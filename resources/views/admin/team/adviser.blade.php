    ...
    <div class="row mt-2">
        <div class="col-lg-12">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form class="form-horizontal" action="{{route('store.adviser')}}" enctype="multipart/form-data" method="POST">
                        @csrf
                ...
                <table id="config-table" class="table display table-striped border no-wrap">
                    ...
                    @foreach ($teams as $team)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('edit.adviser',['id'=>$team->id]) }}" class="btn btn-primary btn-sm editProduct">Edit</a>
