    ...
    <div class="main-content">
        ...
        <div class="rs-inner-blog orange-color pt-100 pb-100 md-pt-70 md-pb-70">
            ...
            <div class="container">
                ...
                @if($blog->id && $blog->publication_type==1) {{-- check its publication or upcoming publication --}}
                            ...
                            <div class="card-body">
                                <h5>Available Author</h5>
                                    ...
                                    @php
                                    $check=\App\Models\OrderTable::where('publication_id',$blog->id)->where('author_id',  $author->id)->first();//check author sold or not
                                    @endphp
                          ...
                          @else
                          <div>
                            <marquee behavior="" direction="" class="text-success text-bold  blockquote">This Publication will come very soon .Kepp your eyes in our website </marquee>
                          </div>
                        @endif
